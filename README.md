...
Estudiante de Ciencias Computacionales en la UANL, apasionada por el desarrollo de software y la creación de soluciones que resuelvan problemas reales.

## 🚀 Sobre mí

- 🎓 Estudiante de Ciencias Computacionales en la UANL
- 💻 Actualmente explorando desarrollo web y aplicaciones
- 🌱 Construyendo proyectos académicos con HTML, CSS, JavaScript y Java
- 🎯 Buscando oportunidades para crecer en proyectos de mayor alcance
- ⚡ Me gusta aprender haciendo: cada proyecto es una excusa para dominar algo nuevo
